...
function validLength(iField, iLen) {
   ...
   if (field_len == 0)
   {
     alert("Name field is required. Please enter a Name that is at least " + min_len + " characters long.");
     iField.focus();
     return false;
   }
...
function validateEmail(iEmail) {
   ...
   var field_len = iEmail.value.length;

   if (field_len == 0)
   {
     alert("Email field is required. Please enter a valid Email address.");
     iEmail.focus();
     return false;
   }
